...
contract Staking {
    ...
    uint256 ninetyDaysRewardPercentage = 40;
    uint256 oneeightyDaysRewardPercentage = 50;
    uint256 threesixtyfiveDaysRewardPercentage = 60;
    ...
    function updateRewardPercentage(uint256 _ninetyDaysRewardPercentage, uint256 _oneeightyDaysRewardPercentage, uint256 _threesixtyfiveDaysRewardPercentage ) public onlyOwner() {
        ninetyDaysRewardPercentage = _ninetyDaysRewardPercentage;
        oneeightyDaysRewardPercentage = _oneeightyDaysRewardPercentage;
        threesixtyfiveDaysRewardPercentage = _threesixtyfiveDaysRewardPercentage;
    ...
    function stakeToken(uint256 _amount, uint256 _timePeriod) public returns(uint256) {
        require(_timePeriod == 90 || _timePeriod == 180 || _timePeriod == 365 );
    ...
    function calculateReward(uint256 _stakeID) public view returns(uint256) {
        ...
        if(stakes[_stakeID].numberOfDays == 90) {
        ...
        } else if(stakes[_stakeID].numberOfDays == 365) {
            rewardPercentage = threesixtyfiveDaysRewardPercentage;
        } 
